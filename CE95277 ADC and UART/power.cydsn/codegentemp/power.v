// ======================================================================
// power.v generated from TopDesign.cysch
// 10/06/2016 at 17:48
...
// Sample_Hold_v1_40(Power=2, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sample_Hold_1, CY_INSTANCE_SHORT_NAME=Sample_Hold_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Sample_Hold_1, )
...
module top ;
    ...
    Sample_Hold_v1_40_1 Sample_Hold_1 (
        .sclk(Net_52),
        .Vin(Net_53),
        .Vout(Net_7),
        .Vref(Net_54));
	...
	cy_clock_v1_0
		#(.id("f9b24792-3464-4a80-ab63-1ecfa41f3c83"),
		  .source_clock_id(""),
		  .divisor(0),
