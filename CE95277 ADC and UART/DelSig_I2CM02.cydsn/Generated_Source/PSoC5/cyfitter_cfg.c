...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000000u)
...
#define BS_UDB_0_3_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000010u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 16u, 0x0Bu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_PRT1_DR) },	/* TD 10 */
		{ 48u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_PRT4_DR) },	/* TD 11 */
		{ 2432u, 0x0Du, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 12 */
		{ 128u, 0x0Eu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U0_BASE) },	/* TD 13 */
		{ 1152u, 0x0Fu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 14 */
		{ 384u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U0_BASE) },	/* TD 15 */
		{ 384u, 0x11u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_U0_BASE) },	/* TD 16 */
		{ 384u, 0x12u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_U0_BASE) },	/* TD 17 */
		{ 384u, 0x13u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_U0_BASE) },	/* TD 18 */
		{ 512u, 0x14u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 19 */
		{ 128u, 0x15u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE) },	/* TD 20 */
		{ 128u, 0x16u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE) },	/* TD 21 */
		{ 128u, 0x17u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE) },	/* TD 22 */
		{ 128u, 0x18u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE) },	/* TD 23 */
		{ 32u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL0_MDCLK_EN) },	/* TD 24 */
		{ 6u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT12_BASE) },	/* TD 25 */
		{ 8u, 0x1Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_IDMUX_IRQ_CTL0) },	/* TD 26 */
		{ 128u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U1_BASE) },	/* TD 27 */
		{ 128u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE + 0x00000080u) },	/* TD 28 */
		{ 128u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 29 */
		{ 128u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE + 0x00000080u) },	/* TD 30 */
		{ 128u, 0x20u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE + 0x00000080u) },	/* TD 31 */
		{ 128u, 0x21u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE) },	/* TD 32 */
		{ 128u, 0x22u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE + 0x00000080u) },	/* TD 33 */
		{ 128u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE + 0x00000080u) },	/* TD 34 */
		{ 128u, 0x24u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 35 */
		{ 128u, 0x25u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE + 0x00000080u) },	/* TD 36 */
		{ 128u, 0x26u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE + 0x00000080u) },	/* TD 37 */
		{ 128u, 0x27u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE + 0x00000080u) },	/* TD 38 */
		{ 128u, 0x28u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_ROUTE_BASE + 0x00000080u) },	/* TD 39 */
		{ 128u, 0x29u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE + 0x00000080u) },	/* TD 40 */
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_ROUTE_BASE + 0x00000080u) },	/* TD 41 */
		{ 128u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE) },	/* TD 42 */
		{ 128u, 0x2Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE) },	/* TD 43 */
		{ 128u, 0x2Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE + 0x00000080u) },	/* TD 44 */
		{ 128u, 0x2Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE) },	/* TD 45 */
		{ 128u, 0x2Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE + 0x00000080u) },	/* TD 46 */
		{ 128u, 0x30u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 47 */
		{ 128u, 0x31u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE) },	/* TD 48 */
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE + 0x00000080u) },	/* TD 49 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_DSISWITCH_0_1_VAL),	/* TD 29 */
		(const void *)(BS_DSI0_1_HV_ROUTING_VAL),	/* TD 30 */
		(const void *)(BS_DSI0_2_HV_ROUTING_VAL),	/* TD 31 */
		(const void *)(BS_DSISWITCH_0_3_VAL),	/* TD 32 */
		(const void *)(BS_DSI0_3_HV_ROUTING_VAL),	/* TD 33 */
		(const void *)(BS_DSI0_4_HV_ROUTING_VAL),	/* TD 34 */
		(const void *)(BS_DSISWITCH_0_5_VAL),	/* TD 35 */
		(const void *)(BS_DSI0_5_HV_ROUTING_VAL),	/* TD 36 */
		(const void *)(BS_UDB_1_0_HV_ROUTING_VAL),	/* TD 37 */
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 38 */
		...
		(const void *)(BS_UDBSWITCH_0_3_VAL),	/* TD 42 */
		(const void *)(BS_DSISWITCH_1_0_VAL),	/* TD 43 */
		(const void *)(BS_DSI3_0_HV_ROUTING_VAL),	/* TD 44 */
		(const void *)(BS_DSISWITCH_1_1_VAL),	/* TD 45 */
		(const void *)(BS_DSI3_1_HV_ROUTING_VAL),	/* TD 46 */
		(const void *)(BS_DSI3_2_HV_ROUTING_VAL),	/* TD 47 */
		(const void *)(BS_DSISWITCH_1_3_VAL),	/* TD 48 */
		(const void *)(BS_DSI3_3_HV_ROUTING_VAL),	/* TD 49 */
	};
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x50u);
...
void AMuxSeq_CYAMUXSIDE_A_DisconnectAll(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT0_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT0_AG)) & (uint8)~0x55u);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT15_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT15_AG)) & (uint8)~0x01u);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT3_AG)) & (uint8)~0x11u);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT2_AG)) & (uint8)~0x40u);
	CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW0, CY_GET_REG8((void CYXDATA *)(CYREG_DSM0_SW0)) & (uint8)~0x04u);
}
...
void AMuxSeq_CYAMUXSIDE_A_Next(void)
{
	...
	case 1:
		...
		CY_SET_REG8((void CYXDATA *)CYREG_PRT15_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT15_AG)) | 0x01u);
		break;
	case 2:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT15_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT15_AG)) & (uint8)~0x01u);
	...
	case 3:
		...
		CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT3_AG)) | 0x01u);
		break;
	case 4:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT3_AG)) & (uint8)~0x01u);
		CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT3_AG)) | 0x10u);
		break;
	case 5:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT3_AG)) & (uint8)~0x10u);
	...
	case 6:
		...
		CY_SET_REG8((void CYXDATA *)CYREG_PRT0_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT0_AG)) | 0x01u);
		break;
	case 7:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT0_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT0_AG)) & (uint8)~0x01u);
		CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT2_AG)) | 0x40u);
		CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW0, CY_GET_REG8((void CYXDATA *)(CYREG_DSM0_SW0)) | 0x04u);
		break;
	}
}
...
void AMuxSeq_CYAMUXSIDE_B_DisconnectAll(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT2_AG)) & (uint8)~0x80u);
	CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW4, CY_GET_REG8((void CYXDATA *)(CYREG_DSM0_SW4)) & (uint8)~0x08u);
}
...
void AMuxSeq_CYAMUXSIDE_B_Next(void)
{
	...
	case 0:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, CY_GET_REG8((void CYXDATA *)(CYREG_PRT2_AG)) | 0x80u);
		CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW4, CY_GET_REG8((void CYXDATA *)(CYREG_DSM0_SW4)) | 0x08u);
		break;
	case 1:
		break;
	case 2:
