// ======================================================================
// DelSig_I2CM02.v generated from TopDesign.cysch
// 10/05/2016 at 19:11
...
// IDAC8_v2_0(Current=10, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=0, Initial_Value=80, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8, CY_INSTANCE_SHORT_NAME=IDAC8, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=IDAC8, )
module IDAC8_v2_0_1 (
    iOut,
    data,
    strobe,
...
module top ;
    ...
    defparam AMuxSeq_CYAMUXSIDE_A.muxin_width = 8;
    defparam AMuxSeq_CYAMUXSIDE_A.init_mux_sel = 8'h0;
    ...
    defparam AMuxSeq_CYAMUXSIDE_B.muxin_width = 8;
    defparam AMuxSeq_CYAMUXSIDE_B.init_mux_sel = 8'h0;
	...
	wire [0:0] tmpOE__Mux_7_net;
	wire [0:0] tmpFB_0__Mux_7_net;
	wire [0:0] tmpIO_0__Mux_7_net;
	wire [0:0] tmpINTERRUPT_0__Mux_7_net;
	electrical [0:0] tmpSIOVREF__Mux_7_net;

	cy_psoc3_pins_v1_10
		#(.id("3eacd475-d8ec-4841-ad8b-2e84949c6299"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_7
		 (.oe(tmpOE__Mux_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_7_net[0:0]}),
		  .analog({Net_125}),
		  .io({tmpIO_0__Mux_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_7_net),
		  .interrupt({tmpINTERRUPT_0__Mux_7_net[0:0]}),
		  .annotation({Net_554}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_6_net;
	wire [0:0] tmpFB_0__Mux_6_net;
	wire [0:0] tmpIO_0__Mux_6_net;
	wire [0:0] tmpINTERRUPT_0__Mux_6_net;
	electrical [0:0] tmpSIOVREF__Mux_6_net;

	cy_psoc3_pins_v1_10
		#(.id("3badf285-82a2-44d2-b906-37c8fc077746"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_6
		 (.oe(tmpOE__Mux_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_6_net[0:0]}),
		  .analog({Net_124}),
		  .io({tmpIO_0__Mux_6_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_6_net),
		  .interrupt({tmpINTERRUPT_0__Mux_6_net[0:0]}),
		  .annotation({Net_553}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_5_net;
	wire [0:0] tmpFB_0__Mux_5_net;
	wire [0:0] tmpIO_0__Mux_5_net;
	wire [0:0] tmpINTERRUPT_0__Mux_5_net;
	electrical [0:0] tmpSIOVREF__Mux_5_net;

	cy_psoc3_pins_v1_10
		#(.id("c5d28206-6e73-4298-9fc9-4b55c4d6cbf9"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_5
		 (.oe(tmpOE__Mux_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_5_net[0:0]}),
		  .analog({Net_123}),
		  .io({tmpIO_0__Mux_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_5_net),
		  .interrupt({tmpINTERRUPT_0__Mux_5_net[0:0]}),
		  .annotation({Net_552}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_4_net;
	wire [0:0] tmpFB_0__Mux_4_net;
	wire [0:0] tmpIO_0__Mux_4_net;
	wire [0:0] tmpINTERRUPT_0__Mux_4_net;
	electrical [0:0] tmpSIOVREF__Mux_4_net;

	cy_psoc3_pins_v1_10
		#(.id("7643af0b-baad-463d-88c5-766b38067da5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_4
		 (.oe(tmpOE__Mux_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_4_net[0:0]}),
		  .analog({Net_122}),
		  .io({tmpIO_0__Mux_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_4_net),
		  .interrupt({tmpINTERRUPT_0__Mux_4_net[0:0]}),
		  .annotation({Net_558}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_3_net;
	wire [0:0] tmpFB_0__Mux_3_net;
	wire [0:0] tmpIO_0__Mux_3_net;
	wire [0:0] tmpINTERRUPT_0__Mux_3_net;
	electrical [0:0] tmpSIOVREF__Mux_3_net;

	cy_psoc3_pins_v1_10
		#(.id("8eb8586e-72e7-4fbb-93f5-34ce0d422961"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_3
		 (.oe(tmpOE__Mux_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_3_net[0:0]}),
		  .analog({Net_121}),
		  .io({tmpIO_0__Mux_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_3_net),
		  .interrupt({tmpINTERRUPT_0__Mux_3_net[0:0]}),
		  .annotation({Net_556}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_2_net;
	wire [0:0] tmpFB_0__Mux_2_net;
	wire [0:0] tmpIO_0__Mux_2_net;
	wire [0:0] tmpINTERRUPT_0__Mux_2_net;
	electrical [0:0] tmpSIOVREF__Mux_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d0aeae95-3459-46d2-a0c1-198562668364"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_2
		 (.oe(tmpOE__Mux_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_2_net[0:0]}),
		  .analog({Net_120}),
		  .io({tmpIO_0__Mux_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_2_net),
		  .interrupt({tmpINTERRUPT_0__Mux_2_net[0:0]}),
		  .annotation({Net_550}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_1_net;
	wire [0:0] tmpFB_0__Mux_1_net;
	wire [0:0] tmpIO_0__Mux_1_net;
	wire [0:0] tmpINTERRUPT_0__Mux_1_net;
	electrical [0:0] tmpSIOVREF__Mux_1_net;

	cy_psoc3_pins_v1_10
		#(.id("9127e74f-f689-4cfe-acd8-a210e7261f25"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mux_1
		 (.oe(tmpOE__Mux_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_1_net[0:0]}),
		  .analog({Net_119}),
		  .io({tmpIO_0__Mux_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_1_net),
		  .interrupt({tmpINTERRUPT_0__Mux_1_net[0:0]}),
		  .annotation({Net_551}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux_0_net;
	wire [0:0] tmpFB_0__Mux_0_net;
	wire [0:0] tmpIO_0__Mux_0_net;
	wire [0:0] tmpINTERRUPT_0__Mux_0_net;
	electrical [0:0] tmpSIOVREF__Mux_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		Mux_0
		 (.oe(tmpOE__Mux_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux_0_net[0:0]}),
		  .analog({Net_118}),
		  .io({tmpIO_0__Mux_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux_0_net),
		  .interrupt({tmpINTERRUPT_0__Mux_0_net[0:0]}),
		  .annotation({Net_26}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5f57d283-5f74-4b79-a777-1dfedd96c5d6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam IDAC8.Initial_Value = 80;
    defparam IDAC8.Strobe_Mode = 0;

	wire [0:0] tmpOE__Current_Source_net;
	wire [0:0] tmpFB_0__Current_Source_net;
	wire [0:0] tmpIO_0__Current_Source_net;
	wire [0:0] tmpINTERRUPT_0__Current_Source_net;
	electrical [0:0] tmpSIOVREF__Current_Source_net;

	cy_psoc3_pins_v1_10
		#(.id("853161dc-dbaf-49f2-a437-fda6561ee046"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Current_Source
		 (.oe(tmpOE__Current_Source_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Current_Source_net[0:0]}),
		  .analog({Net_128}),
		  .io({tmpIO_0__Current_Source_net[0:0]}),
		  .siovref(tmpSIOVREF__Current_Source_net),
		  .interrupt({tmpINTERRUPT_0__Current_Source_net[0:0]}),
		  .annotation({Net_26}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Current_Source_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
